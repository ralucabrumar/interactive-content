...
- Numele orașului, al țării și numărul populației va fi separate unul de celălalt printr-o bară verticală ("\|").

- **Numărul de linii cu date introduse** va fi în intervalul \[2… 50\].

- O pereche oraș-țară nu va fi repetată.

- **Numărul populației** fiecărui oraș va fi un număr întreg în intervalul \[0… 2 000 000 000\].
