...
- Setul poate avea **cel mult o valoare nulă**
- Spre deosebire de Liste și Matrice, Setul **NU** acceptă indici sau poziționarea elementelor sale

**Pe baza caracteristicilor seturilor, acestea poti fi utilizate atunci când:**
- Doriți să stocați elemente unice fără duplicare
...
**Nu oferă garanții** în legătură cu **succesiunea elementelor** atunci când le iterați.

Clasa **HashSet** oferă **performanță** constantă în timp pentru operațiile de bază - `add()`, `remove()`, `contains()` și `size()`.
...
Elementele sunt ordonate pe baza **ordinii lor naturale**.
...
Dacă setul conține deja elementul, acesta rămâne neschimbat și este returnat `false`.
...
-  `remove()` - caută elemental specificat, returnează `true` dacă elementul specificat există în `LinkedHashSet`, iar apoi rlimină elementul; altfel, returnează `false`
...
Scrieți un program care:
  ...
  - Elimină numărul mașinii când mașina părăsește parcarea
...
## Ieșire
Rezultatul constă în toate numerele tuturor mașinilor care se află în parcare.
...
## Intrare
- Până la introducerea comenzii `PARTY`, veți primi invitații pentru oaspeți
...
## Descriere
Scrieți un program care:
   - Citește 20 de numere pentru ambii jucători, separate printr-un **singur spațiu**
   - Fiecare jucător poate **să dețină numai numere unice**
   
La fiecare rundă, ambii jucători iau numărul din partea de sus a pachetului.
